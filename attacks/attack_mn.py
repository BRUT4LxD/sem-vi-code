...
class Attack_MN(object):
    ...
    def forward(self, data_loader: torch.utils.data.DataLoader, *args, **kwargs) -> List[AttackResult]:
        r"""
    ...
    def add_attack_result(self, model_outputs, labels, adv_examples, perturbed_images, init_predicted):
